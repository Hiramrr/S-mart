...
<template>
  <div class="pantalla-admin-productos">
    <Header />
...
.admin-productos-title-centered {
  flex: 1;
  font-size: 2rem;
  font-weight: 600;
  text-align: center;
...
.admin-add-product-btn-minimal:hover {
  background: #1f2937;
}
